...
namespace _2025._02._14._Console_Projekt_Felhasznalasa
{
    public partial class Form1 : Form
    {
        ...
        private void Versenyzokfelvetele()
        {
            ...
            Futas f2 = new Futas("01:20:15", "01:28:05");

            Versenytipus vt = new Versenytipus("123kl", 100, new DateTime(2025, 02, 06));
            Versenytipus vt2 = new Versenytipus("987hv", 2000, new DateTime(2025, 02, 07));
        ...
        {
            Futtathato.versenyzok.ForEach(x => listBox1.Items.Add(x));
